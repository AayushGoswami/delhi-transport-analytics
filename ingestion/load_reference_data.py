...
# ============================================================
# Purpose: Reads GTFS reference files from AWS S3 and loads
#          them into TimescaleDB Cloud reference tables.
# Tables:  routes, stops, trips, calendar
# Source:  s3://delhi-transport-gtfs/
# Target:  TimescaleDB Cloud — tsdb database
# ============================================================
